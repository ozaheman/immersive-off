...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const getCommonFooter = () => `<div class="preview-footer">P.O. Box: 2471, DUBAI (U.A.E) TEL.: 052-8612764, FAX: 04-3492030, E-mail: projects@urban-axis.com<br>Website: www.Urban-axis.com</div>`;
    ...
    function renderReceipt(invoiceData, projectData) {
        ...
        html += `<h2 style="text-align:center;">RECEIPT VOUCHER</h2>
                 ...
                 <div style="margin-top: 80px;">
                    <p style="border-top: 1px solid #333; width: 250px; display: inline-block; padding-top: 5px;">For: IMMERSIVE ENGINEERING CONSULTANTS L.L.C</p>
                 </div>
