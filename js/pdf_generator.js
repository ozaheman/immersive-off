        ...
        try {
            ...
            const addHeaderFooterWatermark = () => {
                ...
                for (let i = 1; i <= pageCount; i++) {
                    ...
                    doc.setFontSize(8);
                    const footerText1 = "E-mail: Info@immersiveec.ae";
            ...
            sourceElement.style.width = '210mm'; // Force A4 width during capture
            ...
            await doc.html(sourceElement, {
                ...
                margin: [TOP_MARGIN + 25, SIDE_MARGIN, BOTTOM_MARGIN, SIDE_MARGIN],
                autoPaging: 'text',
                x: SIDE_MARGIN,
                y: TOP_MARGIN + 25,
                width: CONTENT_WIDTH,
                windowWidth: 800, // Fixed window width for consistent scaling
                html2canvas: {
                    useCORS: true,
                    allowTaint: true,
                    logging: false,
                    scale: (CONTENT_WIDTH * 3.78) / 800 // Convert mm to px at 96 DPI and scale accordingly
                }
            });
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                await doc.html(sourceElement, {
                    ...
                    width: CONTENT_WIDTH,
                    windowWidth: 800,
                    html2canvas: { scale: (CONTENT_WIDTH * 3.78) / 800 }
                });
            } catch (e) {
                reject(e);
            }
