...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const getLetterheadFooterHTML = () => `<div class="preview-footer">P.O. Box: 2471, DUBAI (U.A.E) TEL.: 052-8612764, FAX: 04-3492030, E-mail: chawla@emirates.net.ae<br>Website: www.chawladxb.ae</div>`;
