App.ProjectTabs.Scope = (() => {
    ...
    function init() {
        ...
        <div class="scope-controls">
            ...
            <label style="margin-left: 20px; font-weight: bold; color: #d9534f;">
                <input type="checkbox" id="is-not-new-construction"> Not New Construction
            </label>
        </div>
    ...
    function populateTabData(project) {
        ...
        document.getElementById('is-not-new-construction').checked = project.isNotNewConstruction || false;
    ...
    function getTabData() {
        ...
        data.isNotNewConstruction = document.getElementById('is-not-new-construction').checked;
