...
const DEFAULT_CREDENTIALS = {
    site: { user: 'SiteEngineer@immersiveec.ae', pass: 'site_eng@12345' },
    arch: { user: 'Architect@immersiveec.ae', pass: 'arch@12345' },
    str: { user: 'Structural@immersiveec.ae', pass: 'str@12345' },
    mep: { user: 'MEP@immersiveec.ae', pass: 'mep@12345' },
    pm: { user: 'Manager@immersiveec.ae', pass: 'pm@12345' },
    contractor: { user: 'Contractor@immersiveec.ae', pass: 'contractor@12345' },
    client: { user: 'Client@immersiveec.ae', pass: 'client@12345' },
    viewer: { user: 'Viewer@immersiveec.ae', pass: 'viewer@12345' },
    admin: { email: "admin@immersiveec.ae", password: "password123", role: "admin" },
    manager: { email: "manager@immersiveec.ae", password: "password123", role: "manager" }
};
...
const CONTENT = {
    ...
    AUTHORITY_DETAILS: {
        ...
        DubaiSportsCity: { name: 'M/s Dubai Sports City', address: 'Planning Department<br>Dubai, U.A.E.' },
        EmiratesHills: { name: 'Emirates Hills', address: 'P.O. Box 9440<br>Dubai, United Arab Emirates' },
        Nakheel: { name: 'M/s Nakheel', address: 'Planning Department<br>Dubai, U.A.E.' }
    },
