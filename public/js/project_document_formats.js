const PROJECT_DOCUMENT_TEMPLATES = (() => {
    ...
    const getCommonFooter = () => `<div class="preview-footer">P.O. BOX 341763, DUBAI, U.A.E. Tel. 04262336, E-mail: projects@immersive.ae<br>Website: www.immersiveec.ae</div>`;
        ...
        return `
            <div class="document-preview a4" data-invoice-no="${invoice.no}">
                ...
                <div class="signature-area">
                    <p>For, <strong>IMMERSIVE</strong></p><br><br><br>
    ...
    return {
        ...
        receipt: (project, invoice) => {
            ...
            return `
                <div class="document-preview a4">
                    ...
                    <div class="signature-area">
                        <p>For, <strong>IMMERSIVE ENGINEERING CONSULTANTS L.L.C</strong></p>
                        <br><br><br>
                        <p>_________________________</p>
                        <p>Authorized Signatory</p>
                    </div>
            ...
            return `
                <div class="document-preview a4">
                    ...
                    <div class="signature-area" style="margin-top: 50px;">
                        <p>Certified by, <strong>IMMERSIVE ENGINEERING CONSULTANTS L.L.C</strong></p><br><br><br>
                        <p>_________________________</p>
                        <p>Authorized Signatory</p>
                    </div>
        ...
        <body>
            <div class="cert-container">
                <div class="cert-header">
                    ...
                    <p>P.O. Box: 2471, Dubai, U.A.E. | Tel: 04-3493435 | Email: projects@urban-axis.com</p>
                    <hr>
        ...
        fullAgreement: (data, feeDistribution) => {
            ...
            html += `<h3 style="text-align:center;">AGREEMENT FOR THE PROVISION OF CONSULTANCY ENGINEERING SERVICES</h3>
                      ...
                      <p>AND</p><p><b>M/S. IMMERSIVE ENGINEERING CONSULTANTS L.L.C</b>, of Post Box 281, Dubai, United Arab Emirates (hereinafter referred to as the "CONSULTANT" or the Second party).</p>
            ...
            html += `<h4>${mainCounter + 2}. OWNERSHIP OF DOCUMENTS</h4><p>All technical specifications and other contract documents shall remain the sole property of the Consultant...</p>
                      ...
                      <div class="signature-block">
                          ...
                          <div><b>SECOND PARTY:</b><br><br><br>_________________________<br>M/s. IMMERSIVE ENGINEERING CONSULTANTS L.L.C</div>
                      </div>` + getCommonFooter();
            return html;
        },
        ...
        assignmentOrder: (data) => {
            ...
            html += `<h3 style="text-align:center;">ASSIGNMENT ORDER</h3>
                      <p>I, the undersigned <b>${data.clientName.toUpperCase()}</b>, Owner of Plot No. <b>${data.plotNo}</b>, ${location}, do hereby, appoint M/s. IMMERSIVE ENGINEERING CONSULTANTS L.L.C, Post Box No. 281, Dubai, for the required technical studies and the construction of the ${data.projectDescription} on the above mentioned plot, including the preparation of initial designs, and provisional costs of the project.</p>
                      ...
                      <table style="width:100%;">
                          ...
                          <tr><td><br><b>Signature of the Consultant:</b></td><td><br>_________________________<br>For IMMERSIVE ENGINEERING CONSULTANTS L.L.C</td></tr>
