...
App.ProjectTabs.Documents = (() => {
    ...
    function init() {
        ...
        const mainDocCats = {
            client_details: { title: 'Client Details', types: ['Passport', 'Emirates_ID', 'Affection_Plan', 'Title_Deed', 'SPS', 'Oqood', 'DCR'] },
            noc_copies: { title: 'NOC Copies', types: ['RTA', 'DEWA_Electrical', 'DEWA_Water', 'Du', 'Etisalat', 'Developer_NOC', 'Building_Permit', 'Other_NOC'] },
            letters: { title: 'Project Letters', types: ['Incoming_Letter', 'Outgoing_Letter', 'Site_Memo'] },
            scope_and_agreements: { title: 'Scope & Agreements', types: ['Scope_of_Works', 'Agreement', 'Old_Revision_PDF'] },
            financial_docs: { title: 'Financial Records', types: ['Invoice', 'Tax_Invoice', 'Receipt', 'Payment_Certificate'] },
            other_uploads: { title: 'Other Uploads', types: ['Miscellaneous'] }
        };
